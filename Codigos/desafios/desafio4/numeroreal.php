...
<body>
    <main>
        ...
        <?php 
            ...
            echo"<p>Analisando o número <strong>" . number_format($num, 3, ",", ".") . "</strong> informado pelo usuário temos:</p>";

            $int = (int) $num;

            echo"<ul> <li> A parte interia do número é <strong>" . number_format($int, 0, ",", ".") . "</strong></li>";
